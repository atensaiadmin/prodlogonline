    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4">
      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          />
          <p className="mt-6 font-mono text-[0.72rem] font-semibold uppercase tracking-[0.22em] text-accent">
            Welcome back
          </p>
        ...
        <div className="rounded-2xl border border-border bg-surface p-6 shadow-card">
          ...
          {error && (
            <p className="mt-3 rounded-lg border border-rose-500/20 bg-rose-500/[0.06] px-3 py-2 text-xs text-rose-600 dark:text-rose-400">
              {error === "google"
